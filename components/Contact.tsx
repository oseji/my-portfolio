                ...
                >
                    {submitted ? (
                        ...
                        <>
                            ...
                            <button
                                type="submit"
                                className="mt-1.5 inline-flex cursor-none items-center justify-center gap-2.5 rounded-full bg-white p-4 font-sans text-sm font-medium transition-transform duration-200 ease-out hover:-translate-y-0.5"
                                style={{ color: accent }}
                                data-hover
                            >
                                Send message
