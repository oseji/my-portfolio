...
export const portfolio: Portfolio = {
    ...
    taglines: {
        ...
        qa: {
            ...
            sub: "QA Engineer · Selenium · API Testing · Automation",
            bio: "I'm Ose, a QA engineer focused on delivering reliable, high-quality software through smart automation and thorough testing. I build and maintain Selenium WebDriver frameworks using the Page Object Model to ensure comprehensive coverage. With Postman and Swagger, I validate APIs, verifying data integrity across critical backend systems. I leverage MongoDB to debug and validate transaction records, ensuring data consistency across test and production environments.",
        },
    },
    skills: {
        frontend: [
        ...
        qa: [
            { name: "Selenium (POM)", group: "tools" },
            { name: "Postman / Swagger", group: "tools" },
            { name: "MongoDB Validation", group: "tools" },
            { name: "API Testing", group: "methods" },
            { name: "Regression Analysis", group: "methods" },
