        ...
        frontend: [
            {
                ...
                blurb: "A personal finance tracker for logging income and expenses, setting budgets by category, and watching your spending in real time. The dashboard breaks everything down into charts so you always know where your money is going.",
            ...
            },
            {
                ...
                title: "Binge",
                tag: "Media · Discovery",
                blurb: "A media discovery app for browsing and searching movies and TV series. You can dig into any title for details and trailers, save things to a watchlist, and search across titles and people, all backed by the TMDB API.",
            ...
            },
            {
                ...
                blurb: "An HR management dashboard that covers the day-to-day: employee records, leave request approvals, payroll with automatic tax breakdowns, and performance analytics. Also includes a team scheduling calendar and a file manager for company documents.",
